...
<div style="max-width: 900px; margin: 0 auto; display: flex; flex-direction: column; gap: 1.5rem;">
    ...
    <form action="{{ route('employees.store') }}" method="POST" class="glass-panel" style="padding: 2rem; display: flex; flex-direction: column; gap: 1.75rem;">
        @csrf
        ...
        <div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.25rem;">
                <div class="form-group">
                    ...
                    <input type="text" name="employee_number" value="{{ old('employee_number', $autoNumber) }}" readonly class="form-control" style="background: rgba(0,0,0,0.4); color: #818cf8; font-weight: 700;">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="date_of_birth" value="{{ old('date_of_birth', '1995-01-01') }}" required class="form-control">
                </div>

                <div class="form-group">
                    <label class="form-label">National ID Number *</label>
                    <input type="text" name="national_id" value="{{ old('national_id') }}" required placeholder="NID-XXXXXX-XXX" class="form-control">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.25rem;">
                <div class="form-group">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" required placeholder="john.doe@company.com" class="form-control">
                </div>

                <div class="form-group">
                    <label class="form-label">Phone Number *</label>
                    <input type="text" name="phone" value="{{ old('phone') }}" required placeholder="+1 (555) 000-0000" class="form-control">
                </div>
            </div>

            <div class="form-group">
                <label class="form-label">Physical Address</label>
                <textarea name="address" rows="2" class="form-control" placeholder="Street address, city, state, postal code...">{{ old('address') }}</textarea>
            </div>
        </div>
        ...
        <div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.25rem;">
                ...
                <div class="form-group">
                    ...
                    <select name="position_id" class="form-control" required>
                        @foreach($positions as $pos)
                            <option value="{{ $pos->id }}">{{ $pos->title }} [{{ $pos->salary_grade }}]</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="date_hired" value="{{ old('date_hired', date('Y-m-d')) }}" required class="form-control">
                </div>
        ...
        <div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.25rem;">
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="basic_salary" value="{{ old('basic_salary', '55000.00') }}" required class="form-control">
                </div>

                <div class="form-group">
                    <label class="form-label">Housing Allowance ($)</label>
                    <input type="number" step="0.01" name="housing_allowance" value="{{ old('housing_allowance', '8000.00') }}" required class="form-control">
                </div>

                <div class="form-group">
                    <label class="form-label">Transport Allowance ($)</label>
                    <input type="number" step="0.01" name="transport_allowance" value="{{ old('transport_allowance', '5000.00') }}" required class="form-control">
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1.25rem;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="emergency_contact_relationship" value="{{ old('emergency_contact_relationship') }}" placeholder="Spouse, Parent, Sibling..." class="form-control">
                </div>
            </div>
        </div>
